...
import { createCSSValue, lightenAscentColor } from "../../helpers/styles";
...
const useStyle = makeStyles((theme) => ({
  root: {
    ...
    "& .MuiDrawer-paperAnchorDockedLeft": {
      // backgroundColor: lightenAscentColor(theme, 0),
        ...
        <Container maxWidth="xl">
          {isForm ? (
            <FormProvider {...methods}>
              <form
                onSubmit={
                  disableSubmit ? undefined : methods.handleSubmit(onSubmit)
                }
              >
                <Box
            ...
            <>
              <Box className={clsx(classes.headerFlex, classes.contentHeader)}>
                ...
                <Box className={clsx(classes.headerFlex, classes.action)}>
                  {ContentActionComponent}
                </Box>
              </Box>
              <Grid container className={classes.gridContainer}>
